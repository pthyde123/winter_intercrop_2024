...
OatTraitBLUPs <- read_excel("data/OatTraitBLUPs.xlsx")
...
keepers = round(nrow(OatTraitBLUPs)*.8)  ## number to keep, dropped from .8 to .79 to get final to 90 plots, even number.
